"""
IPPO (Independent PPO) for MPE environments.

Adapted from the JaxMARL reference implementation:
https://github.com/FLAIROx/JaxMARL/blob/main/baselines/IPPO/ippo_ff_mpe.py

Feed-forward actor-critic with parameter sharing across agents.
Fully JIT-compiled; optionally vmapped over multiple seeds.
"""
